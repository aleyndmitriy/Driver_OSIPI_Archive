...
DrvOSIPIArchValues::TagCondition::TagCondition(const std::string& name, const std::string& condVal, ConditionType condType, CombineOperation condOperation) :
	tagName(name), conditionValue(condVal), conditionType(condType), conditionOperation(condOperation)
{

}

DrvOSIPIArchValues::TagCondition::TagCondition() : TagCondition(std::string(), std::string(), ConditionType::CONDTYPE_NONE, CombineOperation::COMBINEOP_NONE)
{

}


DrvOSIPIArchValues::ParamValue::ParamValue(std::string&& address, std::string&& fullAddress, std::string&& sql, bool prevPoint, bool postPoint) :
...
DrvOSIPIArchValues::ParamValue::ParamValue() :ParamValue(std::string(), std::string(), std::string(), false, false)
{

}

DrvOSIPIArchValues::ParamValue::~ParamValue() {

}

std::string DrvOSIPIArchValues::ParamValue::GetAddress() const
{
	return m_Address;
}

const std::string& DrvOSIPIArchValues::ParamValue::GetFullAddress() const
{
	return m_FullAddress;
}

std::string DrvOSIPIArchValues::ParamValue::GetSqc() const
{
	return m_Sql;
}

bool DrvOSIPIArchValues::ParamValue::HasPrevPoint() const
{
	return m_bPrevPoint;
}

bool DrvOSIPIArchValues::ParamValue::HasPostPoint() const
{
	return m_bPostPoint;
}

bool DrvOSIPIArchValues::ParamValue::HasSql() const
{
	return !m_Sql.empty();
}

DrvOSIPIArchValues::TagCondition DrvOSIPIArchValues::ParamValue::parseCondition(const std::string& condition, CombineOperation operation)
{
	std::string res;
...
bool DrvOSIPIArchValues::ParamValue::IsEmpty() const
{
	return m_FullAddress.empty();
}

std::set<std::string> DrvOSIPIArchValues::ParamValue::GetTagsNames() const
{
...
void DrvOSIPIArchValues::ParamValue::createConditionsFromParam()
{
...
const std::vector<DrvOSIPIArchValues::TagCondition>& DrvOSIPIArchValues::ParamValue::GetConditions() const
{
	return m_conditionsList;
}

bool DrvOSIPIArchValues::ParamValueLess(const ParamValue& val1, const ParamValue& val2)
{
