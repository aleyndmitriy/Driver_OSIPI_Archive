...
int32 PIPROC piut_errormsg(int32 stat, char PIPTR *msg, size_t PIPTR *msglen);
int32 PIPROC piut_strerror(int32 stat, char PIPTR *msg, size_t PIPTR *msglen,
                           const char PIPTR *filter);
