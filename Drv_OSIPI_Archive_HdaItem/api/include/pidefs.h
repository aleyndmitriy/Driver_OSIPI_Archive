...
$Archive: /PI/3.4.370/libraries/piut/pidefs.h $
  
-------------------------------------------------------------------------------
Copyright (c) 1994-2010 OSIsoft, LLC. All rights reserved.
...
/* Architecture dependent Windows pointer definitions */
...
/* Macros for numeric limits */
#ifndef MININT8   /* SCHAR_MIN */
#define MININT8 -128
#endif
#ifndef MAXINT8   /* SCHAR_MAX */
#define MAXINT8 127
#endif
#ifndef MAXUINT8   /* UCHAR_MAX */
#define MAXUINT8 255
#endif
#ifndef MININT16   /* SHRT_MIN */
#define MININT16 -32768
#endif
#ifndef MAXINT16   /* SHRT_MAX */
#define MAXINT16 32767
#endif
#ifndef MAXUINT16  /* USHRT_MAX */
#define MAXUINT16 65535
#endif
#ifndef MININT32   /* LONG_MIN */
#define MININT32 (-2147483647L - 1)
#endif
#ifndef MAXINT32   /* LONG_MAX */
#define MAXINT32 2147483647L
#endif
#ifndef MAXUINT32  /* ULONG_MAX */
#ifdef osf1
...
#else
#ifndef MININT64   /* LLONG_MIN */
#define MININT64 (-9223372036854775807LL - 1)
#endif
#ifndef MAXINT64   /* LLONG_MAX */
#define MAXINT64 9223372036854775807LL
#endif
#ifndef MAXUINT64   /* ULLONG_MAX */
#define MAXUINT64 18446744073709551615ULL
#endif
#endif /* linux */
...
/*  Database enum  */
enum PIDBNAMES {
   PIdb_Null            = 0x00000000,
   PIdb_Point           = 0x00000001,
   PIdb_Digital         = 0x00000002,
   PIdb_Attribset       = 0x00000004,
   PIdb_Context         = 0x00000008,
   PIdb_PointClass      = 0x00000010,
   PIdb_User            = 0x00000020,
   PIdb_Group           = 0x00000040,
   PIdb_Trust           = 0x00000080,
   PIdb_Module          = 0x00000100,
   PIdb_Heading         = 0x00000200,
   PIdb_TransferRecord  = 0x00000400,
   PIdb_Campaign        = 0x00000800,
   PIdb_Batch           = 0x00001000,
   PIdb_Unit            = 0x00002000,
   PIdb_Server          = 0x00004000,
   PIdb_Collective      = 0x00008000,
   PIdb_Identity        = 0x00010000,
   PIdb_IdMapping       = 0x00020000,
   PIdb_Acl             = 0x00040000,
   PIdb_AuthInfo        = 0x00080000,
...
/* strnlen() is GNU extension - declare for non-Linux platforms */
#ifndef linux
inline size_t strnlen(const char *str, size_t maxsize)
{
    size_t n;
