...
DrvOSIPIArchValues::BrowserHdaItem::BrowserHdaItem(std::shared_ptr<ISettingsDataSource> settingsDataStore, std::shared_ptr<IServerInteractor> interactor) :
	m_pAttributes(nullptr), m_pDataAttributes(nullptr), m_settingsDataStore(settingsDataStore), m_pBrowserHandler(std::make_shared<BrowserHandler>(interactor))
{

}

void* DrvOSIPIArchValues::BrowserHdaItem::GetInterface(int nIfcId)
{
	return this;
}

int DrvOSIPIArchValues::BrowserHdaItem::Init(TCHAR* szCfgString)
{
	if (szCfgString != NULL)
	{
...
int DrvOSIPIArchValues::BrowserHdaItem::Shut()
{
	return ODS::ERR::OK;
}

ODS::OdsString DrvOSIPIArchValues::BrowserHdaItem::GetAddressOld(const ODS::ItemAddress& rAddress)
{
...
int DrvOSIPIArchValues::BrowserHdaItem::GetBrowseItemList(const ODS::ItemAddress* pAddress, ODS::BrowseItem** ppList, ULONG* pulCount)
{
	int iRes = ODS::ERR::OK;
...
int DrvOSIPIArchValues::BrowserHdaItem::DestroyBrowseItemList(ODS::BrowseItem* pList, ULONG ulCount)
{
	if (pList)
	{
		delete[] pList;
