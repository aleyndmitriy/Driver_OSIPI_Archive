...
DrvOSIPIArchValues::CPropertySet::~CPropertySet()
{
	propertyList.clear();
}


void DrvOSIPIArchValues::CPropertySet::GetPropertyInfoList(ODS::PropertyInfo** ppPropInfoList, ULONG* pulCount) const
{
...
void DrvOSIPIArchValues::CPropertySet::DestroyPropertyInfoList(ODS::PropertyInfo* pPropInfoList, ULONG ulCount) const
{
	delete[] pPropInfoList;
}

void DrvOSIPIArchValues::CPropertySet::GetPropertyList(ODS::Property** ppPropList, ULONG* pulCount) const
{
	*ppPropList = 0;
	if (propertyList.empty()) {
		*pulCount = 0;
...
void DrvOSIPIArchValues::CPropertySet::DestroyPropertyList(ODS::Property* pPropList, ULONG ulCount) const
{
	delete[] pPropList;
}

INT DrvOSIPIArchValues::CPropertySet::GetProperty(ULONG ulPropId, ODS::Property* pProperty) const
{
...
INT DrvOSIPIArchValues::CPropertySet::GetProperty(const TCHAR* pPropName, ODS::Property* pProperty) const
{
	if (!pPropName)
...
INT DrvOSIPIArchValues::CPropertySet::SetProperty(const ODS::Property* pProperty)
{
...
INT DrvOSIPIArchValues::CPropertySet::AddProperty(const ULONG ulId, const TCHAR* szName, const TCHAR* szValue)
{
	ODS::Property prop;
	ULONG propId = ulId;
	prop.SetId(ulId);
...
INT DrvOSIPIArchValues::CPropertySet::AddProperty(const ULONG ulId, const TCHAR* szName, const VARIANT* pValue)
{
	ODS::Property prop;
	ULONG propId = ulId;
	prop.SetId(ulId);
